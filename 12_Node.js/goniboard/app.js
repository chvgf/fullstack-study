...
// (참고) axios 에서도 도메인이 다른데, 쿠키를 공유해야 하는 경우
...
// 이미지 업로드 기능 만들기
// 이미지 첨부를 위한 file input을 이용하여 서버로 이지미를 전송하면 서버 컴퓨터 하드에 저장
